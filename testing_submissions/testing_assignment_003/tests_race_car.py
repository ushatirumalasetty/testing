...
def car():  # Our Fixture function
    ...
    car_obj= RaceCar(color="Red", max_speed=30, acceleration=10, tyre_friction=3)
    return car_obj

@pytest.fixture
def car2():  # Our Fixture function
    from race_car import RaceCar
    car_obj= RaceCar(color="blue", max_speed=50, acceleration=20, tyre_friction=4)
    return car_obj

@pytest.fixture
def car3():  # Our Fixture function
    from race_car import RaceCar
    car_obj= RaceCar(color="blue", max_speed=10, acceleration=3, tyre_friction=3)
    return car_obj



def test_race_car_constructor_when_single_object_is_given(car):
...
def test_race_car_constructor_when_multiple_objects_are_given(car,car2):
...
def test_accelerate_when_nitro_is_not_available(car):
    car.start_engine()
    car.accelerate()
    car.accelerate()
    current_speed=20
...
def test_accelerate_when_nitro_is_available_within_max_speed(car):
    car.start_engine()
    car.accelerate()
    car.accelerate()
    car.apply_brakes()
...
def test_accelerate_when_nitro_is_available_exceed_max_speed(car):
    car.start_engine()
    car.accelerate()
    car.accelerate()
    car.apply_brakes()
...
def test_apply_brake_when_car_is_at_rest(car):
    car.apply_brakes()
    current_speed=0
    assert car.current_speed==current_speed

def test_apply_brake_when_car_is_at_motion_when_less_than_half_of_max_speed(car):
    car.start_engine()
    car.accelerate()
    car.apply_brakes()
    car.apply_brakes()
...
def test_apply_brake_when_car_is_at_motion_when_more_than_half_of_max_speed(car):
    car.start_engine()
    car.accelerate()
    car.accelerate()
    car.apply_brakes()
    ...
    nitro=10
    assert car.current_speed==current_speed
    assert car.nitro==nitro

def test_nitro_when_car_started(car):
    car.start_engine()
    nitro=0
    car.nitro==nitro
